...
#                     print("Save clicked")
        ...
        if state=="menu":
            ...
            draw_pawn(WIN, game_state.board.player1.position[0], game_state.board.player1.position[1], PLAYER_COLOR)  
            draw_pawn(WIN, game_state.board.player2.position[0], game_state.board.player2.position[1], AI_COLOR)  
