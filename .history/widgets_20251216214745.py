...
class CircleButton:
    def __init__(self, center, radius, circle_color,hover_color, text="", font=None, text_color=(0,0,0), border_color=None, border_width=0, action=None):
        self.center = center
        self.radius = radius
    ...
    def draw(self, surface):
        ...
        is_hovered = self.rect.collidepoint(mouse_pos)
        # Draw the circle
        pygame.draw.circle(surface, self.hover_color if is_hovered else self.color, self.center, self.radius)
