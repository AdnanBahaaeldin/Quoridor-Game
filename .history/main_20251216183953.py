...
def main():
    ...
    while run:
        ...
        if state=="menu":
            ...
            radial_gradient(WIN, (WIDTH // 2, HEIGHT // 2), (43, 186, 165), (218, 246, 242))
            # Draw board background
            pygame.draw.rect(WIN, (253, 248, 230), (board_x, board_y, BOARD_PIXEL, BOARD_PIXEL))
