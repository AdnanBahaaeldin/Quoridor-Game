...
def main():
    ...
    while run:
        ...
        if state=="menu":
            ...
            #draw navbar
            undo = pygame.image.load("redo-arrow-symbol.png").convert_alpha()
            undo = pygame.transform.smoothscale(redo, (20, 20))
            redo_rect = redo.get_rect(topleft=(10,10))
            WIN.blit(redo, redo_rect)
