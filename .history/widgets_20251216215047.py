...
class CircleButton:
    def __init__(self, center, radius, circle_color,hover_color, text="", font=None, text_color=(0,0,0),hover_text_cover border_color=None, border_width=0, action=None):
        self.center = center
        self.radius = radius
