...
def highlight_cell(surface, row, col, color):
    rect = pygame.Rect(board_x + col * CELL_SIZE + 3, board_y + row * CELL_SIZE + 3, CELL_SIZE-3, CELL_SIZE-2)
...
def draw_pulse_border(surface, rect, color, time):
    thickness = 3 + int(2 * abs(pygame.math.sin(time)))
