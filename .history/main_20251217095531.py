...
def main():
    ...
    while run:
        ...
        if state=="menu":
            ...
            board.set_player1("Human")
            board.set_player2("AI")
            no_walls_player = 10
            no_walls_ai = 10
            WIN.fill((255, 255, 255))
            #draw navbar
            ...
            text_surf = turn_font.render("It's {}'s turn".format(board.get_current_player()), True, PLAYER_COLOR if board.get_current_player() == "Human" else AI_COLOR)
