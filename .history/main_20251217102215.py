...
def main():
    ...
    while run:
        ...
        if state=="menu":
            ...
            text_surf = turn_font.render("It's {}'s turn".format(new_game.board.get_current_player().name), True, PLAYER_COLOR if new_game.board.get_current_player() == "Blue" else AI_COLOR)
